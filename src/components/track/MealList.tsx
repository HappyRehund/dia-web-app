...
export default function MealsList({meals}: MealsListProps) {
    ...
    const mealsByCategory: Record<string, Meal[]> = meals.reduce((groups, meal) => {
            ...
            {mealsByCategory[category].map((meal) => (
              <Card key={meal.id} className="overflow-hidden">
                <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
                  ...
                  <AlertDialog open={mealToDelete === meal.id} onOpenChange={(open) => !open && setMealToDelete(null)}>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will remove "{meal.name}" from your tracked meals.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
