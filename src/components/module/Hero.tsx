      ...
      <div className="md:flex md:gap-6">
        ...
        <div className="md:w-1/2 flex flex-col gap-4">
          ...
          <button
            ...
            className="absolute right-20 bottom-14 bg-secondary text-white rounded-full py-2 px-4 md:p-6 text-xl flex justify-between items-center shadow-md hover:bg-secondary/90 transition-colors"
          >
